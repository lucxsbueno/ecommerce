...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="../res/ecommerce/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="../res/ecommerce/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../res/ecommerce/css/owl.carousel.css">
    <link rel="stylesheet" href="../res/ecommerce/css/style.css">
    <link rel="stylesheet" href="../res/ecommerce/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="../res/ecommerce//img/logo.png"></a></h1>
                    </div>
                </div>
